...
- [跨域，不止CORS](https://mp.weixin.qq.com/s/9KOZL0c7OnrbCFPj1vzqAw)
...
- [Service Worker实例](https://googlechrome.github.io/samples/service-worker/post-message/)
...
- [postMessage规范](https://developer.mozilla.org/zh-CN/docs/Web/API/Window/postMessage)
